...
export const CropHistoryPage = () => {
    ...
    const CropDetailsPageContent = () => (
        <div className="bg-white min-h-screen">
            {/* Header */}
            <div className="text-white px-6 py-4 flex items-center justify-between" style={{ backgroundColor: '#1f2937' }}>
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            {/* Content */}
            <div className="p-6">
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">Planting History</h2>

                {/* Plantings by Location Chart */}
                <div className="mb-8">
                    <h3 className="text-lg font-medium text-gray-700 mb-4">PLANTINGS BY LOCATION</h3>
                ...
                {plantingHistory.length === 0 && (
                    <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-2">No Planting History</h3>
                        <p className="text-gray-500 mb-4">Start by adding your first planting to see history here.</p>
                        <button
                            onClick={() => setShowNewPlantingModal(true)}
                            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded font-medium"
                        >
