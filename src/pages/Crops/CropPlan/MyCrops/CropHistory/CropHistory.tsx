...
export const CropHistoryPage = () => {
    // Sample data for the chart and planting history
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-200">
                    <h2 className="text-lg md:text-xl font-semibold text-gray-800">Edit Crop Details</h2>
                    <button
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="text-white px-4 md:px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1 md:space-x-2">
                    <button className="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 md:px-4 md:py-2 rounded text-sm md:text-base font-medium">
                        Add Planting
                    </button>
                    <button className="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1.5 md:px-4 md:py-2 rounded text-sm md:text-base font-medium">
                        Harvest
                    </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className=" text-white px-4 md:px-6 py-4 flex items-center justify-between rounded-t-lg">
                    ...
                    <div className="flex items-center space-x-1 md:space-x-2">
                        <button className="bg-green-600 hover:bg-green-700 text-white px-2 py-1 md:px-4 md:py-2 rounded text-xs md:text-base font-medium">
                            Add Planting
                        </button>
                ...
                <div className="p-4 md:p-6">
                    ...
                    <div className="mb-4 md:mb-6">
                        ...
                        <button className="bg-gray-800 text-white px-3 py-1.5 md:px-4 md:py-2 rounded text-xs md:text-sm hover:bg-gray-700">
                            Add Location
                        </button>
                    </div>
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="mb-6 md:mb-8">
                    <h3 className="text-base md:text-lg font-medium text-gray-700 mb-3 md:mb-4">PLANTINGS BY LOCATION</h3>
                        ...
                        <div className="relative h-48 md:h-64">
                            ...
                            <div className="absolute left-0 top-0 h-full flex flex-col justify-between text-xs text-gray-500">
                                {chartData.locations.map((location, index) => (
                                    <div key={index} className="flex items-center h-4 md:h-5 text-xs md:text-xs">
                                        {location}
                                    </div>
                                ))}
                            </div>
